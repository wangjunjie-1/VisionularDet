...
def export_main(config, model_path, output_path, input_shape=(320, 320)):
...
def parse_args():
    ...
    parser.add_argument("--config", type=str, help="Path to .yml config file.")
    parser.add_argument(
        "--model", type=str, default=None, help="Path to .ckpt model."
    )
    parser.add_argument(
        "--out", type=str, default="VisionularDET.nanodet.onnx", help="Onnx model output path."
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    export_main(cfg, model_path, out_path, input_shape)
