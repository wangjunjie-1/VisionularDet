...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(
        ...
        self.pipeline = Pipeline(pipeline, keep_ratio,keep_scale,lowpass_cascade)
        ...
        self.data_info = self.get_data_info(ann_path,img_path)
    ...
    @abstractmethod
    def get_data_info(self, ann_path,img_path=None):
        pass
